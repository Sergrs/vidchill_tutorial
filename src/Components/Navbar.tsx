...
import { Logo, Search, DotsVertical } from "./Icons/Icons";

import { ChangeEvent, KeyboardEvent, useState, Fragment } from "react";
...
export default function Navbar({ children }: NavbarProps) {
  ...
  const handleSearch = async () => {
    try {
      ...
      console.log("Error navigating to search page", error);
    }
  };
